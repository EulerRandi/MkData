...
type
  ...
  private
    ...
    fErrorMsg: string;
  public
    constructor Create( aConnection: TFDConnection; aMySQLDriverLink: TFDPhysMySQLDriverLink);
...
constructor TConnectionApp.Create(aConnection: TFDConnection; aMySQLDriverLink: TFDPhysMySQLDriverLink);
begin
  Self.fConnection := aConnection;
  Self.fMySQLDriverLink := aMySQLDriverLink;
end;
  ...
  begin
    ...
    try
      try
        ...
        Self.fMySQLDriverLink.VendorLib := ExtractFilePath(Application.ExeName)+'\libmysql.dll';
      except on E: Exception do
        begin
          Self.ErrorMsg := E.Message;
        end;
